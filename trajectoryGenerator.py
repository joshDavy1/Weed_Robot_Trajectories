...
class TrajectoryGenerator:
    ...
    def combined_trajectory(self, start_state, weed_pose, start_time, travel_time, spray_time, velocity_y, plot = True):
        """ Returns End State """
    ...
    def generate_full_trajectory(self, start_state, weeds, start_time, travel_time, spray_time, velocity_y, plot = True):
        time = start_time
        state = start_state
        trajectory_functions = []
        for weed in weeds:
            state, traj = self.combined_trajectory(state, weed, time, travel_time, spray_time, velocity_y, plot)
